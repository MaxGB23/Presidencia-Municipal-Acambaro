...
function DataTable({
  ...
  return (
    <>
      <Table>
        <TableHeader>
          <TableRow className="hover:bg-gray-200 bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-700">
            {isEditing && (
              <TableHead className="text-center pr-4 w-36">ACCIONES</TableHead>
            )}
            ...
            <TableHead className="text-center w-12 pr-4 pl-0">
              MODIFICADO
            </TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {data.length === 0 && (
            <TableRow className="dark:bg-gray-800 dark:text-white">
              <TableCell className="p-7" colSpan={12}>
                No hay resultados.
              </TableCell>
            </TableRow>
          )}
              ...
              <TableCell>
                <span
                  className={`px-3 py-2 rounded-full text-white ${
                    statusColors[row.estatus_id as Status] || "bg-gray-400"
                  }`}
                >
      ...
      <div className="flex p-6 pb-0 justify-center items-center">
        <span className="text-gray-500 dark:text-gray-400 text-sm hidden lg:block w-full">
          {totalSolicitudes === 0 ? (
            ...
            <span>
              ...
              {Math.min(currentPage * limit, totalSolicitudes)} de un total de{" "}
              {totalSolicitudes}
            </span>
          )}
        </span>
              ...
              <PaginationItem key={idx}>
                {page === "..." ? (
                  ...
                  <PaginationLink
                    ...
                    className="text-sm px-3 h-9 min-w-[2rem]"
                  >
                    {page}
                  </PaginationLink>
                )}
